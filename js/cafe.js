(function($) {
  ...
  var Cafe = {
    ...
    init: function(options) {
      ...
      $('.js-order-phonenumber-field').each(function() {
        autosize(this);
      });
    ...
    mainBtnClicked: function() {        
      ...
      if (Cafe.modeOrder) {     
        var phone_number = $('.js-order-phonenumber-field').val();
...
/*! My Code */ 
        var toBackendData = JSON.stringify(params);
       Telegram.WebApp.sendData(toBackendData);   
/*!          
